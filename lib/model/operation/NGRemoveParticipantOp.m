...
@implementation NGRemoveParticipantOp

@synthesize participantId;

+ (NGRemoveParticipantOp *) removeParticipant:(NGParticipantId *)theParticipant {
	NGRemoveParticipantOp *removeParticipantInstance = [[[NGRemoveParticipantOp alloc] init] autorelease];
	removeParticipantInstance.participantId = theParticipant;
	return removeParticipantInstance;
}
